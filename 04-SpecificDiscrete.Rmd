...
```{r Geometric, echo=FALSE, fig.height = 6.5, fig.align="center", fig.cap="The pf for the geometric distribution for $p = 0.2$, $0.3$, $0.5$ and $0.8$"}
par( mfrow = c(2, 2))
...
:::{.proof}
Once again it makes sense to prove the third statement initially, and this is left as an exercise.
:::
