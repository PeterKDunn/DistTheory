...
@BIB:Bliss:negbin gives data from the counts of adult European red mites on leaves selected at random from six similar apple trees; see Table \@ref(tab:specdiscrete:negbintrees).
