...
If we run the above code 1000 times, we can record how many cases are recorded at the end of each year (Fig. \@ref(fig:SimA)):

```{r echo=FALSE}
set.seed(10729083)
```

```{r SimA, echo=TRUE, fig.cap="The number of cases per year", fig.align="center", fig.width=4}
