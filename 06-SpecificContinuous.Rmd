...
$$
where $\Phi(z)$ is the distribution function for the standard normal distribution Eq.\ \@ref(eq:ErrorFunction).
...
Selected answers appear in Sect.\ \@ref(AnswersChap5).
...
:::{.exercise #BetaCloud}
@chia1991beta used the beta distribution\index{Beta distribution} to model cloud duration in Darwin, defined as 
...
```{r OneMCircle, echo=FALSE, fig.align="center", fig.cap="A wheel to spin.", fig.align="center", fig.width=5, out.width="50%"}
par( mar = c(1, 1, 1, 1) )
