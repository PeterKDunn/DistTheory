...
Show $X = sum_(i=1}^k X$ where $X\sim \exp(lambda)$ and gives Gam($k, lambda$)

Show X / (X + Y)\si, Beta(\alpha, \beta)$ if $X\sim Gam(alpha, 1)$ and $Y \sim Gam(\beta, 1)$.

See CHap (RVs): Beta prime distribution: If $p$ has a beta distribution, th4 odds $p/(1- p)$ has beta prime distribution
