...
Some distributions cannot be written in closed form (i.e., a neat function of standard mathematical function), which makes (for example) evaluation of probability and computation of means difficult.
...
Howevevr, the value of\ $c$ could be found using numerical integration in **R**:
...
Const <- 1 / integrate(g, 
                       lower = 0, 
                       upper = Inf)$value
cat("\n\n The value of  c  is about", round(Const, 4), "\n\n")
...
```{r, plotOddFnFig, fig.cap='The density function (left) and distribution function (right) of a distribution that cannot be ', fig.align='center', out.width='100%', fig.width=10, echo=FALSE}
<<plotOddFn>>
```
