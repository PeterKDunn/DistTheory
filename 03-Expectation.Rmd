...
Suppose a disease occurs in an unknown proportion of people $p = 0.1$ of people.
In Ex. \@ref(exr:PooledTest), the probability distribution of the random variable 'whether the pooled test returns a negative test' $X$ was found when $n = 4$.

1. What is the expected number of tests needed when $n = 4$?
1. What is the variance of the number of tests needed when $n = 4$?1
