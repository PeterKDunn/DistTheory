...
:::{.example #InfiniteMean name="Mean not defined (OR INFINITE?)"}
...
This expected value is not finite.
...
```{r NoMean, fig.align="center", fig.cap="The probability function for the random variable Z", fig.height = 3.5, fig.width=4}
z <- seq(1, 6, 
         length = 100)
plot(x = z,
     y = z^(-2),
...
For that reason, the variance is also UNDEFINDED, since computing the variance relies on having a finite value for $\text{E}(X)$.
:::
