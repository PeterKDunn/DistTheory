...
For a symmetric distribution, the odd central moments are zero (Exercise \@ref(exr:SkewDiscreteCentralMomemntsZero)).
...
(This exercise folows from Exercise \@ref(exr:#TriangularHospital.)
