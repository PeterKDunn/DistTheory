...
\[
   \text{E}[Z] = \int_1^{-\infty} z \frac{1}{z^2}\, dz = \int_1^\infty \frac{1}{z} = \left. -\log z \right_1^\infty.
\]
...
```{r NoMean, fig.align="center", fig.cap="The probabilityfunction for the random variable Z"}
z <- seq(1, 6, 
         length = 100)
plot(x = z,
     y = z^(-2),
...
\[
   \text{E}(Y^r) = \mu'_r = \left.\frac{d^r}{dt^r} M_Y(t)\right g|_{t = 0}.
\]
:::
...
The moment generating function can be used to derive the distribution of a function of a rv (see Sect. \@ref(SEC:transforms:mgf)).
...
=======
>>>>>>> fdc16f85d371e454a0612ba1b66f9c8ef2eff1b5
