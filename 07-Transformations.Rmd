...
Let the two discrete random variables $X_1$ and $X_2$ have the joint pf shown in Table \@ref(tab:Bivar4).\smallskip
...
\[ 
   \Pr(X = x) = \binom{4}{x} (0.2)^x (0.8)^{4 - x} \quad \etxt{for $x = 0, 1, 2, 3, 4$}, 
\]
