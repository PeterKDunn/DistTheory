...
Selected answers appear in Sect.\ \@ref(AnswersChap7).
...
1. Determine the df of $Y$ in terms of the function $\Phi(\cdot)$ (see Def. \@ref(def:StdNormalPhiNotation)). 
...
1. Produce a well-labelled plot of the pdf of $Y$.
   Ensure all important points, etc. are clearly labelled.
:::
