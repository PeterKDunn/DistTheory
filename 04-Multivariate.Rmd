...
```{r BivarJointa, echo=FALSE, fig.cap="A bivariate distribution.", fig.align="center", out.width='50%', fig.width = 7}
...
```{r BivarConditionala, echo=FALSE, fig.cap="A bivariate distribution, sliced at $Y =  1$, showing the conditional distribution of $X$ when $Y = 0.5$.", fig.align="center", out.width='50%', fig.width = 11}
...
So, for example,
$$
   f_{X \mid Y = 1.5}(x\mid y = 1.5)
   = \frac{ (2/7) (x + 2\times 1.5)}{ (1/7)(1 + 4\times 1.5)}
   = \frac{2}{7}(x + 3)
$$
for $0 < x < 1$ and is zero elsewhere. 
And,
$$
   f_{X\mid Y = 1}(x \mid 1)
   = \frac{ (2/7) (x + 2\times 1)}{ (1/7)(1 + 4\times 1)}
   = \frac{2}{5}(x + 2)
$$
for $0 < x < 1$ and is zero elsewhere. 
