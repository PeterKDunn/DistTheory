# (PART) Bivariate and multivariate distributions {-}
...
## Bivariate random variables: independent random variables {#BivariateIndependentRVs}
...
## Multivariate random variables using matrix notation {#Multivariate}
