...
Each outcome $(X(s), Y(s))$ (usually written as $(X, Y)$) is represented as a point $(x, y)$ in this plane, and is called a *random vector*.\index{Random vector}\index{Random variable!two-dimensional}
...
Consider the joint PDF
$$
   f_{X, Y}(x, y) = k ( 1 - x) y \qquad \text{for the region $R$ below}.
$$
...
Consider the joint PDF
$$
   f_{X, Y}(x, y) = k (x + 2y) y \qquad \text{for the region $A$ below}
$$
