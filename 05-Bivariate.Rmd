...
```{r Bivar1graphlatex, echo=FALSE, warning=FALSE, message=FALSE, fig.cap="A bivariate discrete probability function.", fig.align="center", out.width='60%',fig.width=5}
...
```{r, BVCont3, echo=FALSE, fig.align='center', fig.width=5, fig.height=5, out.width='60%',fig.cap="The bivariate continuous uniform distribution."}
