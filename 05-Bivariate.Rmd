...
Then,
\begin{align*}
  f{Y\mid X = 1}(y\mid X = 1) &= 1\quad\text{for $0 < x < 1$};
  f{Y\mid X = 2}(y\mid X = 2) &= 0.5\quad\text{for $0 < x < 2$};
  f{Y\mid X = 3}(y\mid X = 3) &= 1\quad\text{for $1 < x < 2$}.
\end{align*}
...
Then,
\begin{align*}
  f{Y\mid X = -1}(y\mid X = -1) &= 0.5\quad\text{for $-1 < x < 1$};
  f{Y\mid X =  1}(y\mid X = 1)  &= 0.25\quad\text{for $-2 < x < 2$}.
\end{align*}
