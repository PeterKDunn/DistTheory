...
$$
  \sum_{x \in \mathcal{R}_X} \int_{-\infty}^{\infty} f_{Y|X}(y|x) P(X=x) \, dy = 1.
$$
...
```{r Bivar1graphlatex, echo=FALSE, warning=FALSE, message=FALSE, fig.cap="A bivariate discrete probability function.", fig.align="center", out.width='70%',fig.width=6}
...
```{r, BVCont3, echo=FALSE, fig.align='center', fig.width=6, fig.height=5, out.width='70%',fig.cap="The bivariate continuous uniform distribution."}
