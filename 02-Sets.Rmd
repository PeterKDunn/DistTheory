...
Theoretically, this is not true, to avoid difficulties like that in *Russell's paradox*.\index{Russell's paradox}
...
To prevent such a paradox, modern set theory (such as ZFC)\index{ZFC} places restriction on how sets can be formed (though we will not discuss these limits).
:::
