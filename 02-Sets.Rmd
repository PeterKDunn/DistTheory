...
$$
In this expression, $\lfloor x \rfloor$ is the *floor* function\index{Floor function}, that rounds the value of\ $x$ to the next lowest integer (for example, $\lfloor \pi \rfloor = 3$ and $\lfloor e\rfloor = 2$).
