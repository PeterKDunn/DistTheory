...
\end{align*}
This is read as '$F$ is the set of all\ $s$ drawn from the names of students in a certain course, such that\ $s$ is a students whose mark less than $50$%'.
