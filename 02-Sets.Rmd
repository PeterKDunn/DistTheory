...
If\index{Uncountably infinite sets}\index{Cardinality!Uncountably infinite sets} the elements cannot be listed without omitting elements, the set is called a *uncountably finite* set.
