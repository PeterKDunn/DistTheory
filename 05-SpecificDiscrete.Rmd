...
if( knitr::is_latex_output() ) {
   knitr::kable(MitesTab,
                ...
                col.names = c("No. mites per leaf", 
                              "No. leaves with that many mites",
                              "Empirical prob.",
                              "Poisson prob.",
                              "Neg. bin. prob."),
...
In a study of rainfall disaggregation (extracting small-scale rainfall features from large-scale measurements), the number of non-overlapping rainfall events per day at Katherine was modelled using a Poisson distribution (for $x = 0, 1, 2, 3, \dots$) with $\lambda = 2.5$ in summer and $\lambda = 1.9$ in winter [@connolly1998daily].
...
1. Find the probability that\ $Y$ is greater than $1$\ m.
2. If readings on four different days are taken what is the probability that exactly two are greater than $1$\ m?
:::
