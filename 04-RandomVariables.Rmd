...
Let\ $X$ be a discrete random variable with range $\mathcal{R}_X$.
...
The *probability function* of a mixed random variable\ $X$ is characterized by:
...
The above ideas can be applied in the discrete case, but care is needed at the values of the random variable where the probability is non-zero.
...
The same ideas apply for continuous random variables, but probabilities are accumulated using integrations rather than summations.
...
The distribution function for mixed random variables follow the same ideas as above, using summations and integrations as appropriate.
