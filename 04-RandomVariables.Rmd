...
```{r QuantileFnContinuous1, echo=FALSE, fig.align="center", fig.cap="Left: the distribution function of $X$. Centre: the distribution function. Right: the quantile function for $X$.", fig.width=6.5, fig.height=3, out.width='100%'}
par(mfrow = c(1, 3))
