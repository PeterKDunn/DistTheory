...
```{r RDistributions, fig.cap="The density functuon and distribution function produced by R.", out.width="80%", fig.width=7, fig.height=4, echo=FALSE, fig.align="center"}
par( mfrow = c(1, 2) )
<<Curvefx>>
<<CurveFx>>
```

Then, $\Pr(0.2 < X < 0.6)$ can be found using the distribution function also:
