...
```{r SurvivalVsDistributionDiscretePlot, echo=FALSE, fig.cap="Relationship between distribution and survival functions", out.width="90%", fig.width=8, fig.height=5}
p <- 1/6
x <- 0:20

Fx <- pgeom(x - 1, 
            prob = p)   # P(X <= x) for Geometric
Sx <- 1 - pgeom(x - 1, 
                prob = p)  # P(X > x)
