...
Let the range of the discrete random variable\ $X$ be\ $\mathcal{R}_X$.
...
The most common example is when an exact probability exists when the value of the random variable is zero (discrete), and the random variable is then continuous for positive values.
