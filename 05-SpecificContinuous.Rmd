...
Show that the variance of the normal, Poisson and gamma distributions can all be written in the form $\text{var}(X) = \phi \text{E}(X)^p$ for $p = 0, 1$ and $2$ respectively.
:::
