...
The four **R** functions for working with the continuous uniform distribution have the form `[dpqr]unif(min, max)`.
:::
...
::: {.softwareBox .software data-latex="{iconmonstr-laptop-4-240.png}"}
The four **R** functions for working with the normal distribution have the form `[dpqr]norm(mean, sd)`.
...
::: {.softwareBox .software data-latex="{iconmonstr-laptop-4-240.png}"}
The four **R** functions for working with the exponential distribution have the form `[dpqr]exp(rate)` where `rate`${}= \lambda = 1/\beta$.
:::
...
The four **R** functions for working with the gamma distribution have the form `[dpqr]gamma(shape, rate, scale = 1/rate)`, where `shape`${}= \alpha$ and `scale`${}= \beta$.
:::
...
The four **R** functions for working with the beta distribution have the form `[dpqr]beta(shape1, shape2)`, where `shape1`${}= m$ and `shape2`${}= n$.
:::
