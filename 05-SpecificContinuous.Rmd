...
As an example, suppose the heights adult females have a mean of 163cm with standard deviation of 6cm.
Simulation can be used to model the heights of three females:
...
Suppose we are seeking women over 175cm tall for a study; what percentage of women re over 170cm tall?
...
Suppose adult males have a mean of 175cm with standard deviation of 7cm, and constitute 48% of the population.
Mow, we are seeking *people* over 175cm tall (Fig. \@ref(fig:HeightSimHistograms), right panel):
...
```{r echo=TRUE}
personSex <- rbinom(1000, 
                    1,
                    0.48) # So 0 = Male; 1 = Female

htP <- rnorm(1000,  # One thousand women
...
```{r HeightSimHistograms, fig.width=7, out.width='100%', fig.cap="kukudq"}
par( mfrow = c(1, 2))
