...
1. Deduce, and the plot, the corresponding distribution functions.
...
For 'Green' patients, the service time $S$ (in minutes) was modelled as $S = 4.5 + 11V$, where $V \sim \text{Beta}(0.287, 0.926)$.

1. Find the mean and standard deviation of the service times $S$.
1. For the model, what is the range of $S$?
1. Plot the pdf of $S$.
...
1. Simulate 1000 headways using **R**. 
   Estimate the probability that a headway is within two standard deviations of the mean. 
1. Compare the probability found above with the bound according to Tchebyshev's inequality.
:::
