...
4. $f_X''(x) = 0$ when $x = \mu \pm \sigma$ (points of inflexion).
...
```{r ContCorrBoxes, echo=FALSE, fig.width=7, fig.height=4, out.width='70%', fig.align="center", fig.cap="The normal distribution approximating the binomial distribution when $n = 100$, $p = 0.3$ and finding the probability that $X > 34$."}
n <- 100
p <- 0.3
