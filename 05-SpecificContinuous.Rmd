...
Suppose adult males have heights with a mean of 175cm with standard deviation of 7cm, and constitute 48% of the population.
...
1. What proportion of vehicles are excluded using this criterion?
...
3. For May 2008, compute $\Pr(X > 60), where $X$ is the relative humidity.
4. For May 2008, compute $\Pr(X > 60 \mid X > 50), where $X$ is the relative humidity.
5. For May 2008, 80% of days have a relative humidity less than what value?
:::