...
:::{.exercise #GammaCV}
Show that the gamma distribution has a constant *coefficient of variation*, where the *coefficient of variation* if the standard deviation dvided by the mean.
:::
