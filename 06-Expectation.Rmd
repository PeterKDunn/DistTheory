...
::: {.importantBox .important data-latex="{iconmonstr-warning-8-240.png}"}
In the rest of this chapter, mixed random variable\ $X$ will not be explicitly discussed; however, the results remain a combination of the discrete case for the discrete points in\ $\mathcal{R}_X$ and the continuous case for the continuous component of\ $\mathcal{R}_X$.
:::
