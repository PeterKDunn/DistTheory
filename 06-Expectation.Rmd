...
As a result, the characteristic function can be used to recover the PDF for a continuous random variable (also see Sect.\ \@ref(DistributionFromMGF) for recovering the PMF for a discrete random variable).  
