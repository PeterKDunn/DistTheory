...
$$
Using Eq.\ (\@ref(eq:MGFtoPDFcontinuous)), the distribution can be recovered as
\begin{align*}
  f_X(x) 
...
\end{align*}
Since $f_X(x)$ is real, take the real parts:
\begin{align*}
  f_X(x) 
  &= \frac{1}{2\pi} \int_{-\infty}^{\infty}  \frac{\cos(tx) + t\sin(tx)}{1 + t^2} \, dt,
\end{align*}
This is not an easy integral to complete without using complex analysis; nonetheless, we obtain
$$
  f_X(x) = \exp(-x),
$$
