...
The MGF may not converge to a finite value for all values of\ $t$, so ma not be defined everywhere.
...
$$
   \operatorname{E}[u(X, Y)]
   = \iint_{(x, y)\in R} u(x, y)\, p_{X, Y}(x, y).
$$
:::
...
Intuitively, the law of total expectation says that the overall mean of\ $X$ is 
a weighted average of the conditional means of\ $X$, weighted by the distribution 
of\ $Y$.
