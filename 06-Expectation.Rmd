...
All cumulants of the distribution are equal to $\lambda$.
:::
\index{Cumulant generating function|)}
...
For heavy-tailed distributions such as the Cauchy or Pareto, the MGF does not exist in any neighbourhood of zero, and hence neither does the CGF.
...
\end{align*}
This is not an easy integral to complete without using complex analysis; nonetheless, using tabulated integral results (see Sect.\ \@ref(CFIntegrals)), we obtain
$$
  f_X(x) = \exp(-x),
$$
