...
\begin{align*}
  ...
  &= \sum_y \left(\sum_x x\cdot p_{X\mid Y}(x\mid y)\right) p_Y(y)\\
...
\begin{align*}
  \operatorname{E}[X \mid Y = -1] &= \sum_x x\cdot p_{X\mid Y}(x\mid -1)
...
1. If $X\sim N(1000, 100)$, find the exact probability and compare.
...
3. If $X\sim\text{Poisson}(20)$, use **R** to find the exact value of $\Pr(|X-20|\geq 8)$ and compare to your bound.
:::
