...
Consider again the experiment in Examples \@ref(exm:BVDiscreteEG) and \@ref(exm:BVDiscreteTossRoll). 
...
Consider the joint distribution of $X$ and $Y$ in Example \@ref(exm:BVDiscreteTossRoll). 
...
```{r RandomMarginal, echo=FALSE, out.width='100%', fig.width = 4.75, fig.height=2.25, fig.align="center", fig.cap="Marginal distributions"}
par( mfrow = c(1, 3),
     mar = c(5, 2, 4, 2) + 0.1)
...
:::{.exercise #DiscreteXY}
Discrete rvs $X$ and $Y$ have the joint pf shown in Table .
Determine:
...
1. Use that $Y = X + r$ to derive the mean and variance of $X$, given that $\E(Y) = r/p$ and $\text{var}(Y) = r(1 - p)/p^2$.
...
:::{.exercise}
Wilks [BOOK][p~101] states that the maximum daily temperatures measured at Ithaca ($I$) and Canandaigua ($C$) in January 1987 are both symmetrical. 
