...
#### Interpretation of a conditional pdf {#ConditionalInterpretation}

To interpret for example, $f_{X \mid Y = y}(x \mid y)$, consider slicing through the surface $f_{X, Y}(x, y)$ with the plane $y = c$ say, for $c$ a constant (Fig. \@ref(fig:BivarNormalConditionalInterpretation)). 
...
```{r BivarNormalConditionalInterpretation, webgl=TRUE, echo=FALSE, fig.cap="A bivariate distribution, sliced at $Y =  c$, showing the conditional distribution of $X$ when $Y = c$", fig.align="center", out.width='70%'}
mu <- c(0, 0)
...
Independence is, however, obvious from the description of the experiment (Example \@ref(exm:BVDiscreteEG)). 
This can be most easily seen from Table \@ref(tab:JointPF).
:::
