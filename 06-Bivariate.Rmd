...
:::{.definition #BivariateProbFunction name="Continuous bivariate distribution function"}
...
```{r BivarConditionalInterpretation, webgl=TRUE, echo=FALSE, fig.cap="A bivariate distribution, sliced at $Y =  c$, showing the conditional distribution of $X$ when $Y = c$", fig.align="center", out.width='100%', fig.width = 7}
...
\]
Recall the interpretation of the conditional distribution of $X$ given $Y = y$ (Sect. \@ref(ConditionalInterpretation)) and note the shape of this density in Fig. \@ref(fig:BivarNormal).
:::
...
\begin{align}
  ...
  &= \begin{cases}
     ...
     {0.9 e^{-10}10^x + 0.1 e^{-20}{20^x}} & \text{for $\mu = 20$}.\label{EQ:accidents3}
  \end{cases}
\end{align}
