...
Suppose that\ $X$ and\ $Y$ are discrete random variables, where $p_Y(y)$ is the probability function for\ $Y$ and $p_{X \mid Y}(x,y)$ is the conditional PMF for\ $X$ given\ $Y$.
...
\begin{align*}
   ...
   &\propto f_{X|\Theta}(x\mid \theta)      \times f_\Theta(\theta)\\
   \text{Posterior distn} 
