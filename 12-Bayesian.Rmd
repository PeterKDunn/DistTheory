...
\end{align}
where the integral can be simplified by seeing it is a Beta function (see Equation\ (@ref(eqn:BetaFunction)) with parameters $x + 4$ and $14 - x$, so that $\int_0^1 \theta^{x + 3}(1 - \theta)^{10 - x + 3}\,d\theta = \Gamma(x - 4)\Gamma(14 - x)/\Gamma(18)$.
Then:
$$
  p_X(x)
