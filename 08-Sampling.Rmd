...
We use $\bar{X}$ to represent the mean of a sample whose value is as yet unknown (and depends on 8which* sample is selected).
...
The pdf of $\frac{U_1/\nu_1}{U_2/\nu_2}$ and teh rest of the proof is not given.
:::
