...
$$
  \Pr( X_{(7)})(X = 2) \approx 0.019 = 1.9\%.
$$
:::


```{r OrderStatsDiscreteExample, echo=FALSE, fig.align="center", fig.cap="Left: the distribution of the first order statistic (the minimum roll), in sets of $10$\\ rolls. Right: the distribution of the $7$th order statistic, in sets of $10$\\ rolls. In both cases, the bars show the values from $5\\,000$ simulated sets of $10$\\ rolls, and the solid dots are the theoretical values.", fig.width=8, fig.height=4, out.width="90%", results='hide', echo=FALSE}
