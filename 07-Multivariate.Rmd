...
The range space of $(X, Y)$, written $R_{X \times Y}$, will be a subset of the Euclidean plane. 
...
```{r Bivar1graphlatex, echo=FALSE, warning=FALSE, message=FALSE, fig.cap="A bivariate discrete probability function.", fig.align="center", out.width='70%',fig.width=11}
