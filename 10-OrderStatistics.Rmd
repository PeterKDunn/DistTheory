...
This means that, for example, is a set of $10$\ rolls, the probability that the minimum roll is a two is about
$$
  \Pr( X_{(7)})(X = 2) \approx 0.1442 =  14\%.
$$
:::
...
This means that, for example, is a set of $10$\ rolls, the probability that the seventh smallest roll is a two is about
$$
