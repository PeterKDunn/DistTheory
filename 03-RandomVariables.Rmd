...
The sample space\ $S$ contains $36$\ elements:
$$
...
$$
   R_X = \{1,  2,  3,  4,  5,  6,  8,  9, 10, 12, 15, 16, 18, 20, 24, 25, 30, 36\}.
$$
...
$$
or more usually and succinctly as $X > 10$.
Other events can be defined also:
\begin{align*}
   A_2 &= \{\text{$4 \le X < 10$}\} = \{ 4,  5,  6, 8,  9 \};\\
   A_3 &= \{\text{$X$ is prime}\} = \varnothing;\\
   A_4 &= \{\text{$X$ is evenly divisible by\ $8$}\} = \{ 8, 16, 24\}.
\end{align*}
:::
