...
1. See that $X = 1$ (i.e., one pooled test, and all are negative; no further testing needed) or $X = 5$ (the pooled test is positive, so $n$ individual tests are needed in addition to the pooled test).
   So the sample space is $\{1, 5\}$.
