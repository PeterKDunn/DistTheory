...
<!-- ```{r, out.width='90%', fig.align="center", fig.cap="A pdf and cdf"} -->
<!-- f <- function(x){ -->
<!--   f <- array( dim = length(x)) -->
<!--   f[x < 0.6] <- 0 -->
<!--   f[x > 9.4] <- 0 -->
...
```{r, echo=FALSE, out.width='90%', fig.align="center", fig.cap="A pdf and cdf"}
par( mfrow = c(1, 2))
...
```{r echo=FALSE, fig.align="center", fig.cap="Exceedance charts"}
...
\[
  \Pr(D = 8) = \frac{4 \times 20}{52 \times 51}.
\]
For a 'distance' of $7$, we need either $(3, 10)$ or $(10, 3)$, or $(2, 9)$ or $(9, 2)$, with prob.  
\[
  \Pr(D = 7) = \frac{4 \times 20}{52 \times 51} + \frac{4 \times 4}{52\times 51} \times 2.
\]
For a 'distance' of $6$, we need either $(4, 10)$ or $(10, 4)$, or $(3, 9)$ or $(9, 3)$, or $(2, 8)$ or $(8, 2)$, with prob.  
\[
  \Pr(D = 6) = \frac{4 \times 20}{52 \times 51} + \frac{4 \times 4}{52\times 51} \times 4.
\]
...
\[
  \Pr(D = 0) = \frac{4 \times 20}{52 \times 51} \times 2 + \frac{4\times 4}{52\times 51}\times 8.
\]
...
```{r, fig.align="center", fig.cap="A pdf and cdf"}
fd <- function(x){
  log10( 1 + 1/d)
}
