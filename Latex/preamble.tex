...
\renewenvironment{definition}%
  {\begingroup\definecolor{shadecolor}{RGB}{242, 242, 242}\vspace{1mm}\begin{quote}\vspace{-4mm}\origdefinition\setlength{\parskip}{2mm}
}%
...
\renewenvironment{example}%
  {\begingroup\definecolor{shadecolor}{RGB}{232, 232, 232}\vspace{1mm}\begin{quote}\vspace{-4mm}\origexample\setlength{\parskip}{2mm}
}%
  {\origendexample\end{quote}\vspace{-1mm}\endgroup\vspace{1mm}}}

\AtBeginDocument{%
\let\origendtheorem=\endtheorem%
\let\origtheorem=\theorem%
\renewenvironment{theorem}%
  {\begingroup\definecolor{shadecolor}{RGB}{245, 245, 245}\vspace{2mm}\begin{quote}\vspace{-4mm}\origtheorem\setlength{\parskip}{2mm}}%
