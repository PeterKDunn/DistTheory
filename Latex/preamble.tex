...
\renewenvironment{definition}%
  ...
  {\origenddefinition\end{quote}\vspace{-1mm}\endgroup}}

\AtBeginDocument{%
\let\origendexample=\endexample%
\let\origexample=\example%
\renewenvironment{example}%
  {\begingroup\definecolor{shadecolor}{RGB}{232, 232, 232}\begin{quote}\vspace{-4mm}\origexample
}%
  {\origendexample\end{quote}\vspace{-1mm}\endgroup}}
