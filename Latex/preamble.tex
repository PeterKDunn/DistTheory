...
%\usepackage{minitoc}% Chapter TOC
...
\renewenvironment{definition}%
  ...
  {\origenddefinition\end{quote}\vspace{-1mm}\endgroup\vspace{2mm}}}

\AtBeginDocument{%
\let\origendexample=\endexample%
\let\origexample=\example%
\renewenvironment{example}%
  {\begingroup\definecolor{shadecolor}{RGB}{232, 232, 232}\vspace{2mm}\begin{quote}\vspace{-4mm}\origexample
}%
  {\origendexample\end{quote}\vspace{-1mm}\endgroup\vspace{2mm}}}
