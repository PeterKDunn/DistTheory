...
\renewenvironment{definition}%
  {\begingroup\definecolor{shadecolor}{RGB}{242, 242, 242}\vspace{1mm}\begin{quote}\vspace{-4mm}\origdefinition
}%
...
\renewenvironment{example}%
  {\begingroup\definecolor{shadecolor}{RGB}{232, 232, 232}\vspace{1mm}\begin{quote}\vspace{-4mm}\origexample
}%
...
\renewenvironment{theorem}%
  {\begingroup\definecolor{shadecolor}{RGB}{245, 245, 245}\vspace{2mm}\begin{quote}\vspace{-4mm}\origtheorem}%
