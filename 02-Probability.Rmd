...
SEE CHAP 5 SECTION ALSO! And consolidate them, or at least make sure they say different things

Computing and working with probabilities can be hard!
In many cases, computer *simulation* can be used to help with compouting probabilities.


:::{.definition #Simulation name="Simulation"}
A *simulation* is when a computer is used to imitate a real situation many times, so that probabilities or outcomes can be *estimated*.
:::
...
4. **Checking answers and reasoning.**
...
### Simulation to confirm results {#SimulationConfirmation}
...
### Simulation to check answers and reasoning {#SimulationChecking}
