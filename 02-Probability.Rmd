...
Probability relates to the outcomes of *random processes* (or *random experiments*).
...
The possible outcomes of a random process constitute a universal set for the random process, called the *sample space*.
...
If the cardinality of the sample space is finite or countable infinite, then an event is a collection of sample points.
