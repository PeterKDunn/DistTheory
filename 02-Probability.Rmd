...
2. Use a computer simulation to estimate the probabilities to determine the best strategy.
   *Hint:* crucial information is that the host of the show who knows where the car is, and opens one of the doors *not* selected by the contestant, *and reveals a goat*. 
:::
