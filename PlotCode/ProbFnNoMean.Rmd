...
```{r NoMean, echo=FALSE, fig.cap="The probability function for the random variable $Z$. The mean is not defined.", out.width='100%', eval=knitr::is_html_output(), include=knitr::is_html_output()}
eval(parse(text = my_Code))
```
