...
author: "Peter K. Dunn and Taryn Axelsen"
...
These chunks comment on notation.
:::
...
The online version of this textbook is **free** for anyone to use; there is no charge for students, instructors or institutions.

Although not essential, an email to one of the authors (explaining how the textbook is being used, who is using the textbook, and your thoughts on the textbook) would be appreciated: `pdunn2 <at> usc.edu.au`.
...
Peter K. Dunn and Taryn Axelsen (2024). *The theory of statistical distributions*.
