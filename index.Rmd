...
#   ```
# These are needed, as places where I use < and > in tables, the html fails
...
<!--- In HTML, < gets rendered as &lt; in table headers etc. So: --->
<!-- $\\newcommand{\\lt}{<}$ -->
<!-- $\\newcommand{\\gt}{>}$ -->
...
<!-- # DID NOT WORK: DEFAULT R code size. From: https://stackoverflow.com/questions/38323331/code-chunk-font-size-in-beamer-with-knitr-and-latex -->
...
Peter K. Dunn (2023). *The theory of distributions*.
