...
In **R**, these function start with the letter `r` (see Sect.\ \@ref(UseRDistributions) for details for specific distributions); for example:
...
Since random numbers are being generated, each simulation will produce different results, so we repeat this over many simulations (each generating different a realisation):
