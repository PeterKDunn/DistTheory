...
Since random numbers are being generated, each simulation will produce different results, so we repeat this over many simulations (each generating different a realisation):\index{R()@\texttt{R}!loops}
