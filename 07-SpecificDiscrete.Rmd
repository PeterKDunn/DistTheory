...
```{r DiscreteUnform, echo=FALSE, fig.align="center", fig.cap="The probability function for the discrete uniform distribution $\\text{Uniform}(a, b)$.", fig.width=5, fig.height=3.5, out.width='50%'}
x <- c(1:4, 7)
y <- rep(1, length(x))
