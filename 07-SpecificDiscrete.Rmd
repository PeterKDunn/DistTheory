...
1. Identify *how* to estimate\ $p$ from knowing an estimate of the slope of the regression line ($\beta_1$), and then how to estimate\ $N$ from the $y$-intercept ($\beta_0$).
