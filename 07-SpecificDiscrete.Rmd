...
The four **R** functions for working with the binomial distribution have the form `[dpqr]binom(., size, prob)`.
That is:
...
:::{.example #LakeFreezes name="Freezing lake"}
...
::: {.softwareBox .software data-latex="{iconmonstr-laptop-4-240.png}"}
The four **R** functions for working with the geometric distribution have the form `[dpqr]geom(., prob)` (see Appendix \@ref(UseRDistributions)):\index{dgeom()@\texttt{dgeom()}}
...
::: {.softwareBox .software data-latex="{iconmonstr-laptop-4-240.png}"}
The four **R** functions for working with the negative binomial distribution are based on the paramaterisation in Eq.\ \@ref(eq:NegativeBinomialPMF), and have the form `[dpqr]nbinom(., size, prob)`:\index{dnbinom()@\texttt{dnbinom()}}
...
where `prob` is\ $p$ and `size` is\ $r$ (see Appendix \@ref(UseRDistributions)).
:::
...
::: {.softwareBox .software data-latex="{iconmonstr-laptop-4-240.png}"}
The four **R** functions for working with the Poisson distribution have the form `[dpqr]poiss(., lambda)` (see Appendix \@ref(UseRDistributions)):\index{dpois()@\texttt{dpois()}}
...
::: {.softwareBox .software data-latex="{iconmonstr-laptop-4-240.png}"}
The four **R** functions for working with the hypergeometric distribution functions have the form `[dpqr]hyper(., m, n, k)` (see Appendix \@ref(UseRDistributions)):\index{dhyper()@\texttt{dhyper()}}
