...
We can then draw a histogram of the number of fertile eggs laid by females (Fig. \@ref(fig:EggsSimulation)):\index{hist()@\texttt{hist()}}
...
```{r echo=FALSE, fig.cap="Plots from the call-center modelling. Left: the number of calls per hours. Right: the handling time per hour.", out.width='100%', fig.width=8, fig.align="center" }
par(mfrow = c(1, 2))
