...
* `dgeom(x, prob)` computes the probability function at $X = {}$`x`;
* `pgeom(q, prob)` computes the distribution function at $X = {}$`q`;
...
* `dnbinom(x, size, prob)` computes the probability function at $X = {}$`x`;
* `pnbinom(q, size, prob)` computes the distribution function at $X = {}$`q`;
...
* `dpois(x, lambda)` computes the probability function at $X = {}$`x`;
* `ppois(q, lambda)` computes the distribution function at $X = {}$`q`;
...
* `dhyper(x, m, n, k)` computes the probability function at $X = {}$`x`;
* `phyper(q, m, n, k)` computes the distribution function at $X = {}$`q`;
