...
The distributions discussed in this chapter and standard and commonly-used discrete distributions.

TALK ABOUT WHERE USEFUL.

Other useful discrete distributions include:

* The Zeta distribution (or sometimes, teh Zipf distribution), with $p_X(x) = x^{-\alpha}/\zeta(\alpha)$ for $x = 1, 2, \dots$ where $\zeta(\alpha)$ is the Riemann zeta function.
  The Zeta distribution is often used in linguistics, and  for heavy-tailed counts.
* The zero-truncated Poisson distribution, with $p_X(x) = 1, 2, \dots$.
* The zero-inflated Poisson distribution, with $p_X(x) = 0, 1, 2, \dots$.
