...
```{r Bernoulli, echo=FALSE, fig.align="center", fig.cap="The probability function for the Bernoulli distribution $\\text{Bernoulli}(a, b)$.", fig.width=5, fig.height=3.5, out.width='50%'}
par(mfrow = c(1, 2))
