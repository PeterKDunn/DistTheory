...
* `qgeom(p, prob)` computes the quantiles for cumulative probability `p`; and
...
* `qnbinom(p, size, prob)` computes the quantiles for cumulative probability `p`; and
...
* `qpois(p, lambda)` computes the quantiles for cumulative probability `p`; and
...
* `qhyper(p, m, n, k)` computes the quantiles for cumulative probability `p`; and
