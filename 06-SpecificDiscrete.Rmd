...
### Derivation and definition: standard parameterisation {#NegBinStandard}
...
We write $X\sim\text{NB}(r, p)$ r $X\sim\text{Negative binomial}(r, p)$.
:::
...
### Properties: standard parameterisation {#NegBinProperties}
...
### Alternative parameterisations {#NegBinAlternative}
...
Relaxing the restriction on\ $r$ means the probability function becomes
\begin{equation}
...
```
The probability of upgrading within one year is about\ $85$%.
:::
