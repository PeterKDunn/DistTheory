...
The probability mass function for\ $M$ can be found from the distribution function as usual (see Equation\ \@ref(eq:DFtoPDFdiscrete)): $f_M(m) = F_M(m) - F_M(m - 1)$.
...
This expression does not simplify to a standard named distribution in general.
...
fm1 <- pbinom(m_vals, size = n1, prob = p1) * 
          pbinom(m_vals, size = n2, prob = p2) -
       pbinom(m_vals - 1, size = n1, prob = p1) * 
          pbinom(m_vals - 1, size = n2, prob = p2)
...
fm2 <- pbinom(m_vals, size = n1, prob = p1) * 
         pbinom(m_vals, size = n2, prob = p2) -
      pbinom(m_vals - 1, size = n1, prob = p1) * 
         pbinom(m_vals - 1, size = n2, prob = p2)
