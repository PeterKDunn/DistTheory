...
```{r BivarNormalPDF, echo=FALSE, fig.cap="A bivariate normal distribution with means of\\ $0$, variances of\\ $1$, and correlation coefficient of\\ $0.5$.", fig.align="center", out.width='100%'}
mu <- c(0, 0)
...
Using this sample information, the bivariate normal distribution can be described.
A $3$-dimensional function can be difficult to plot on a two-dimensional page, but see 
`r if( knitr::is_latex_output() ) {
