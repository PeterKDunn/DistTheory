...
```{r BivariateContinuousXformCoVSupport, echo=FALSE, fig.align="center", fig.cap="The orginal support in the $(x_1, x_2)$-plane (left), and the support for the transformed variables in the $(y_1, y_2)$-plane (right).", out.width='100%', fig.width=8, fig.height=3.5}
par(mfrow = c(1, 2))
