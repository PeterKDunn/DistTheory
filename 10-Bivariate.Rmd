...
The change of variable method (Sect.\ \@ref(BivariateChangeOfVariable)) and the distribution function method (Sect.\ \@ref(BivariateDF)) are both considered 


### Bivariate change of variable method {#BivariateChangeOfVariable}

First consider the case when two random variables\ $X_1$ and\ $X_2$ are *discrete* random variables, with a joint probability mass function $p_{X_1, X_2}(x_1, x_2)$ defined on the two-dimensional set of points\ $R^2_X$ for which $p(x_1, x_2) > 0$.
...
Note that $(-1, 0)$ and $(1, 0)$ both map to $(1, 1)$.
...
$$
so that $\operatorname{det} J = -1/2$.
...
\begin{align*}
  ...
  &= \frac{(y_1 + y_2)(y_1 - y_2)}{16} \quad \text{for $0 < y_1 + y_2 < 2$ and $0 < y_1 - y_2 < 4$}.
\end{align*}
:::
