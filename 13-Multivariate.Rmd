...
```{r echo=FALSE, WorkToHome, fig.width=6, out.width='50%', fig.align="center", fig.cap="The journey from Home (H) to Work (W). TL represent traffic lights; SS represents a Stop Sign; TR represents a right turn."}
plot( x = c(-1, 11)* 3,
      y = c(-1, 5),
      axes = FALSE,
      xlab = "",
