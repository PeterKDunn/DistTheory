...
The *$t$-distribution*\index{t-distribution} (Sect.\ \@ref(TDistribution)) is similar to a normal distribution (and defined on the entire real line), but with heavier tails.
The *$\chi^2$ distribution*\index{Chi-square distribution} (Sect.\ \@ref(ChiSquareDistribution)), with $\nu$\ degrees of freedom and defined on $(0, \infty)$, is related to the sums of independent squared normal distributions.
It is a special case of a gamma distribution with $\alpha = \nu/2$ and $\beta = 2$ (Exercise\ \@ref(exr:ChiSquaredGamma)).
The *$F$-distribution*\index{F distribution} (Sect.\ \@ref(FDistribution)), defined on $(0, \infty)$, is related to the ratio of independent $\chi^2$ distributions.
