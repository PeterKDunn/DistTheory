...
Some authors---especially in non-theoretical work---use the notation $X\sim N(\mu,\sigma)$ (that is, the second argument is the standard deviation, rather than the variance) so it is wise to check each article or book for the notation used.
