...
The *von Mises distribution*\index{von Mises distribution} is defined on $[\i, pi)$ and is used to model angles; it is sometimes called the 'circular normal distribution'. 
