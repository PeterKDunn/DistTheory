...
The *continuous uniform distribution*\index{Contimnuous uniform distribution} is used to model complete randomness when all values in an interval are equally likely.
