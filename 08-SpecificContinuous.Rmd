...
* `qunif(p, min, max)` computes the quantiles for cumulative probability `p`; and
...
* `qnorm(p, mean, sd)` computes the quantiles for cumulative probability `p`; and
...
* `qexp(p, rate)` computes the quantiles for cumulative probability `p`; and
...
* `qgamma(p, shape, rate)` computes the quantiles for cumulative probability `p`; and
...
* `qgamma(p, shape, scale)` computes the quantiles for cumulative probability `p`; and
...
* `qlnorm(p, meanlog, sdlog)` computes the quantiles for cumulative probability `p`; and
...
* `qbeta(p, shape1, shape2)` computes the quantiles for cumulative probability `p`; and
