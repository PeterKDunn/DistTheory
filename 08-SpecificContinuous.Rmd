...
The *beta distribution*\index{Beta distribution} is used for modelling proportions (or probabilities) that are not counts of a fied number (when a *binomial distribution*\index{Binomial distribution} is appropriate), such as cloud cover, fractional resource consumption, etc.
...
The *$t$-distribution*\index{t-distribution} is similar to a normal distribution (and defined on the entire real line), but with heavier tals.
The *$\chi^2$ distribution*\index{Chi-square distribution}, defined on $(0, \infty)$, is related to the sums of independent squared normal distributions.
The *$F$-distribution*\index{F distribution}, defined on $(0, \infty)$ is related to the ratio of independent $\chi^2$ distributions.
