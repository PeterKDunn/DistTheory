...
```{r ExponentialDistributions, echo=FALSE, fig.align="center", fig.cap="Exponential distributions for various values of the rate parameter $\\lambda = 1/\\beta$.",fig.width=6,fig.height=3.5, out.width='60%'}
x <- seq(0, 10,
         length = 100)
