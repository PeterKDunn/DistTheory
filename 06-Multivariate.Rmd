...
:::{.exercise #Mixture}
A company produces a $500$\ g packet of 'trail mix' that includes a certain weight of nuts $x$, dried fruit $y$, and seeds $z$.
...
2. Suppose the weight of nuts *plus* dried fruit must be between $300$\ g and $400$\ g.
   Draw the sample space.
3. *In addition*, suppose the weight of nuts must be *at least* $100$\ g, and the weight of dried fruit must be *at least* $100$\ g.
   Draw the sample space.
