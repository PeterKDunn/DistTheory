...
:::{.exercise #Mixture}
A company makes (among other products) a mixture of nuts, dried fruits and granola.
Write $X$ for the weight of nuts in the mix, $Y$ for the weight of dried fruit in the mix, and $Z$ for the weight of granola in the mix.

1. Explain why the joint distribution of $X$ and $Y$ gives all the information necessary to study the mix.
2. For one mix sold by the company, the total weight is 500g, and the mix must contain between 100g and 200g of granola.
   Draw the sample space.
3. **In addition**, the mix must contain at least 100g of nuts and at least 100g of dried fruit.
   Draw the sample space; called this region $T$.
4. The joint pdf modelling the distribution of nuts and dried fruits is  
   \[
     f_{X, Y}(x, y) = k,
   \]
   over the sample space $T$.
   Find the value of $k$.
:::
