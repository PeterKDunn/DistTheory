...
:::{.exercise #TransformReproductive}
Let $S_1 \sim \text{CP-G}(\lambda_1,\alpha,\beta)$ and $S_2 \sim \text{CP-G}(\lambda_2,\alpha,\beta)$ be independent with the same Gamma parameters.  
Show $S_1+S_2 \sim \text{CP-G}(\lambda_1+\lambda_2,\alpha,\beta)$.
:::
