...
* probability function (XREF);
* distribution function (XREF);
* quantile function (XREF); and
* random number generation

is available for standard distributions (and some non-standard distributions).
