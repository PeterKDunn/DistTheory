...
SymbolsTab[7, ] <- c("Superscript $c$", 
                     "Set complement", 
                     "(ref:Sets)")
SymbolsTab[8, ] <- c("$\\aleph_0$", 
                     "R-squared", 
                     "(ref:Sets)")
SymbolsTab[9, ] <- c("$\\mathfrak{c}$", 
                     "Cardinality of the continuum", 
                     "(ref:Sets)")
SymbolsTab[10, ] <- c("$\\mathbb{N}$", 
                     "Set of natural (counting) numbers", 
                     "(ref:Sets)")
SymbolsTab[11, ] <- c("$\\mathbb{Z}$", 
                     "Set of integers", 
                     "(ref:Sets)")
SymbolsTab[12, ] <- c("$\\mathbb{Q}$", 
                     "Set rational numbers" , 
                     "(ref:Sets)")
SymbolsTab[13, ] <- c("$\\mathbb{R}$", 
                     "Set of real numbers", 
                     "(ref:Sets)")
SymbolsTab[14, ] <- c("$\\mathbb{R}^{+}_0$", 
                     "Set of non-negative real numbers", 
                     "(ref:Sets)")
SymbolsTab[15, ] <- c("$\\mathbb{R}_{+}$", 
                     "Set of positive real numbers", 
                     "(ref:Sets)")
SymbolsTab[16, ] <- c("$\\mathbb{R}_{-}$", 
                     "Set of negative real numbers", 
                     "(ref:Sets)")
SymbolsTab[17, ] <- c("$\\mathbb{C}$", 
...
SymbolsTab[32, ] <- c("$\\operatorname{erf}(x)$", 
                     "Error function", 
                     "(ref:ContinuousDistributions)")
