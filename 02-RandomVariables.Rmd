...
1. The data in Table \@ref(tab:RainArray) shows the total monthly rainfall at Charleville, Queensland, from 1942 until 2022 for the months of June and December. (Data supplied by the Bureau of Meteorology.)
   Plot $1 - F_X(x)$ for this rainfall data for each month on the same graph.
1. Suppose a producer requires at least 800 mm of rain in June to plant a crop.
