...
For example, when a fair die is rolled, the classical approach to probability can be used to determine the theoretical probabilities $\Pr(\text{roll\ a\ \epsdice{1}}) = \Pr(\text{roll\ a\ \epsdice{2}}) = \cdots = \Pr(\text{roll a \epsdice{6}}) = 1/6$.
