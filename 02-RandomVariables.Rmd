...
```{r Diode, echo=TRUE, fig.align="center", fig.cap="The probability function for the diodes example", fig.width=4.5, fig.height=4}
p <- 0.4
x <- seq(0, 4, 
         length = 100)
fy <- (1 - p) * exp( - x)
...
```{r DFCont, echo=TRUE, fig.align="center", fig.cap="The probability function (left) and the distribution function (right) for $V$", fig.width=7, out.width='100%', fig.height=3.5}
par(mfrow = c(1, 2))
