...
\begin{align*}
     \Pr(X = 2) &= \Pr\left((1, 2)\right) &= 1/10\\
     \Pr(X = 3) &= \Pr\left((1, 3) \text{ or }  (2, 3)\right) &= 2/10\\
     \Pr(X = 4) &= \Pr\left((1, 4) \text{ or } (2, 4) \text{ or } (3, 4)\right) &= 3/10\\
     \Pr(X = 5) &= \Pr\left((1, 5) \text{ or } (2, 5) \text{ or } (3, 5)\text{ or } (4, 5)\right) &= 4/10
\end{align*}
...
```{r ProbDist1, echo=FALSE, fig.align="center", fig.cap="The probability function for the larger of two numbers drawn", fig.width=4}
plot( x = 2:5,
      y = c(0.1, 0.2, 0.3, 0.4),
      xlim = c(1.75, 5.25),
      ylim = c(0, 0.4),
...
```{r ProbDistributionCoin, echo=FALSE, fig.align="center", fig.width=4,fig.cap="The probability function for $H$, the numbver of heads on two tosses of a coin"}
plot( x = 0:2,
      y = c(0.25, 0.50, 0.25),
      ylim = c(0, 0.55),
      type = "h",
...
```{r ContinuousPDF, echo=FALSE, fig.align="center", fig.cap="The probability function for $W$", fig.width=4}
plot( x = c(-1, 2),
      y = c(0, 2),
      type = "n",
      las = 1,
...
```{r Diode, echo=FALSE, fig.align="center", fig.cap="The probability function and distribution function for the diodes example", fig.width=5, out.width='80%'}
par( mfrow = c(1, 2))
...
```{r HeadsDF, echo=FALSE, fig.cap="A graphical representation of the distribution function for Example \\ref(exm:TossingHeads2). The filled circles contain the given point, while the empty circles omit the given point.", fig.width=4}
plot( x = c(-1, 4),
      y = c(0, 1.05),
      type = "n",
      las = 1,
