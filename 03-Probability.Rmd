...
* *Sensitivity (true positive rate):* If a passenger is on the watchlist, the system correctly generates an alert with probability $\Pr(A \mid W) = 0.85$ (85%).
...
4. Write a short **R** code snippet using Bayes' theorem to compute $P(W \mid A)$ for a vector of prior probabilities $\Pr(W) \in [10^{-6}, 10^{-2}]$.
:::
...
* *False Positive Rate:* If an essay is human-written, the tool mistakenly flags it as AI-generated with probability $P(F \mid H) = 0.04$ (4% FPR, or 96% specificity).
