...
We could model the situation using a (censored) normal distribution for the monthly rainfall.
The latent variable\ $Y\sim N(\mu_R = 50, \sigma_R^2)$, with $\Phi(0) = \Pr(Y < 0) = 0.30$, for some variance $\sigma_R^2$.
...
BUT WHY? JUST USE THEORETICAL DISTN!
