...
Even though the probability function has no closde form, the MGF is reasonably simple.
...
Simulation for the censored, hurdle and compound Poisson-gamma models can all be achieved through modelling the zeros according to the model incorporartes them.
...
```{r PoissonGammaSim, echo=FALSE, fig.align="center", fig.cap="A simulatiion of the compound Poisson--gamma models, both with mean and varaince set to $1$. FIX!!!!! The solid dot at $X = 0$ represents the discrete probability.", fig.width=8, fig.height=4, out.width="90%"}
