...
Using $\Pr(Toss head) = 0.5$, R was used to simulate 500 tosses.
...
Stone and Auliciems~\cite{BIB:Stone:SOIphase} have defined five phases of the SOI that can be attributed to any given month.
...
If the number is even, there are only three possibly outcomes in the sample space: $S_R = \{ \epsdice{2}, \epsdice{4}, \epsdice{6}\}$,
...
Check back at the Definition \@ref(def:MutuallyExclusive) for the concept of mutual exclusiveness.
