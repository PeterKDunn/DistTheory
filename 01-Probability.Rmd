...
* the **union** of sets $A$ and $B$, written as $A\cup B$, is the combined set of all the points in either $A$ or $B$, or both. 
  (Usually we just say that $A\cup B$ is the points in '$A$ or $B$'.)
...
TossNunber <- 1:NumTosses)           # Sequence: toss number
PropHeads <- cumsum(Tosses) / RunningTosses  # P(Heads) after each toss
...
abline( h = 0.5,       # Draw horizontal line at y = 0
