...
The set $R$ refers to the real numbers $x$, and can be defined by a *rule*: $R \{ x | x > 0\}$, where the notations means 'the set R consists of elements $x$ such that all values of $x$ are greater than zero'.
