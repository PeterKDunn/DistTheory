...
The definition for a *random process* is fairly vague.
...
WE DEFINE SSPACE USING "SETS", THEY INTROUCE THE TERM "SETS"
...
The *elements* (or sample points) of the set are denoted by lower-case letters, and are shown to belong to a set by enclosing them in braces:
\[
   A = \{ a_1, a_2, a_3, a_4\}.
\]
:::
