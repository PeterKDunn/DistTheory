...
Biologically, about $75$% of peas are expected to be round; the data appear reasonably sound in this respect.

Is the type of pea (rounded or wrinkled) *independent* of the colour?
That is, if the pea is rounded, does it impact the colour of the pea?
...
Mammograms are generally conducted on women over 40, though breast cancer rarely occurs in women under 40.
...
This partly explains why mammograms for women under 40 are not commonplace: most women who return a positive test result actually do not have breast cancer.
...
That is, winning numbers drawn,m in the order, as $\{1, 2, 3, 4, 5, 6, 7\}$ are effectively the same as if they were drawn in the order $\{7, 2, 1, 3, 4, 6, 5\}$.
