...
As $\overline{A}\cupA = S$ (by definition of the complement) and $\Pr(S) = 1$ (axiom 2), then $1 = \Pr(\overline{A}) + \Pr(A)$, and the result follows.
:::
...
Bracket matching is an interestiomg mathematical problem!
