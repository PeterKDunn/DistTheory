...
* understand the concepts of probability and associated rules and terms.
* define probability from different perspectives and apply them to compute probabilities in various situations.
* explain and apply the concepts of conditional probability and independence.
* distinguish mutually exclusive events and independent events.
* apply Bayes' Theorem by using the formula and tree diagrams.
...
The intention is to think of a *random process* as a process by which data is gathered.
...
Listing the sample space is difficult as there are a very large number of options for selecting seven numbers from 47.
:::
