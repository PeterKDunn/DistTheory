...
Notice that $23 + 14 + 3 = 40$ of the experiments result in 15 or more CAO patients doing better on Condition 1 while $2 + 1 + 10 + 22 = 35$ of the experiments result in 6 or fewer of the CAO patients doing better on Condition 1.
That is, 75 out of the 1000 experiments resulted in an outcome as extreme as the one observed in the actual experiment, or an estimated probability of .075 that a result this extreme would occur purely by chance if there is in fact NO DIFFERENCE in effect of the two experimental conditions.
