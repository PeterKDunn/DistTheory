...
Each student in the sample then selects one card at random from the prepared pile of $N$ cards, and answers 'True' or 'False' to the question 'Is the statement on the selected card true or false?' without divulging which statement is on the card. 

Let $\Pr(Y)$ be the probability that a student answers 'True', and $\Pr(D)$ the probability that a student chosen at random has used an illegal drug.
