...
1. all four numbers drawn are *even*.
1. exactly two even numbers are drawn.
...
:::{.exercise #WorldCup}
At a Cricket World Cup, each squad consist of fifteen players, from which a team of eleven must be chosen for each game. 
Suppose a squad consists of five bowlers, seven batsmen, two all-rounders and and one wicketkeeper.

1. Find the number of teams possible if the team consists of five batters, four bowlers, one all-rounder and one wicketkeeper.
2. After a game concludes, each member of one team shakes hands with each member of the opposing team, and each member of both teams shakes hands with the two umpires.
...
1. Compare the actual factorials with the Stirling number approximations for $n = 1, \dots, 10$.
