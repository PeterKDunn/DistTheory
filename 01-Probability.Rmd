...
Then,
\begin{align*}
   E \cap G       &= \{4, 6\}     \qquad    E \cup G     &= \{ 2, 4, 5, 6\}\\
   \overline{E}   &= \{ 1, 3, 5\} \qquad    \overline{G} &= \{ 1, 2, 3\}.
\end{align*}
...
```{r SimTosses, echo=TRUE, fig.cap = "A simulation of tossing a fair coin $1000$ times. The probability of getting a head is computed from the data after each toss.", fig.width = 4, fig.height=3.5}
...
```{r BallThrow, echo=FALSE, fig.align="center", fig.cap="A rough probability model for throwing distance", fig.width=7, fig.height = 4, out.width='80%'}
par( mfrow = c(1, 2))
