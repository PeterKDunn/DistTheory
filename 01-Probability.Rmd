...
* Finite, such as the set comprising the six states of Australia.
...
* By describing a pattern.
  The set $N$ could be defined by the pattern: $N = \{2, 4, 6, \dots\}$.
...
Essentially, a random process produces data with an unknown outcome.
...
Set algebra has many rules; we only provide some, for sets $A$, $B$ and $C$ defined on the same sample space.
...
\]
$n$ needs to be very large--and the sample random--to compute probabilities accurately, and approximate probabilities can only ever be found.
...
Using data supplied by the DPI\footnote{The Department of Primary Industries.} from 1882 to 1994 (113 years), rain fell in 96 years during April.
...
Toss a cricket ball 100 times, and about 10% of the time it goes further than 50m; 20% further than 40m; and 50% of the times fiurther than 30m; and 100% of the time further than 20m.
:::
