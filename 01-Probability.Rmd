...
```{r SimTosses, echo=TRUE, fig.cap = "A simulation of tossing a fair coin $1000$ times. The probability of getting a head is computed from the data after each toss.", fig.width = 5}
...
```{r BallThrow, echo=FALSE, fig.align="center", fig.cap="A rough probability model for throwing distance", fig.width=5, out.width='80%'}
par( mfrow = c(1, 2))
...
```{r BreastTree, echo=FALSE, fig.align="center", fig.cap="Tree diagram for the breast-cancer example", out.width='80%'}
